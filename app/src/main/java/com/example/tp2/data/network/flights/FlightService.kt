...
class FlightService {
    ...
    val BASE_URL_DETAILS: String ="https://d702356f-b2c7-4435-9339-ac0e1d874db7.mock.pstmn.io"
    ...
    suspend fun getDetails(): GetDetailsApiResponse {
        return withContext(Dispatchers.IO) {
            ...
            val retrofit = retroFitBuilder.create(DetailsImage::class.java)

            retrofit.getDetails().body()!!;
        }
    }
}